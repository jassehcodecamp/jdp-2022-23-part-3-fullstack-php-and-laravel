                               ...
                               @foreach($todos as $todo)
                                <li class="text-gray-600 text-sm flex items-center justify-between space-x-6">
                                    ...
                                    <div class="space-x-1.5 flex items-center">
                                        @if ($status != 'deleted')
                                        <a href="{{ route('todos.edit', $todo->id)}}" class="text-gray-50 bg-gray-500 py-1.5 px-2 text-xs rounded">Edit</a>
                                        ...
                                        <form method="POST" action="{{route('todos.restore', $todo->id)}}">
                                            @csrf
                                            @method('PATCH')
                                            <button class="text-red-50 bg-amber-500 py-1.5 px-2 text-xs rounded">Restore</button>
                                        </form>
                                        @endif
